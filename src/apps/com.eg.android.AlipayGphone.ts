      ...
      rules: [
        {
          ...
          activityIds: 'com.alipay.mobile.nebulax.xriver.activity.XRiverActivity$App',
          position: { 
          ...
          matches: '@ViewGroup[childCount=2] - View[top=getPrev(0).bottom] -2 View[right=width] < [childCount=4] < * < * < * < * <2 [id="android:id/content"][childCount=2]',
        ...
        },
        {
          ...
          matches: 'View[width=getPrev(5).width] - @ViewGroup[childCount=1][height<150][getChild(0).name$=".View"][visibleToUser=true] < [childCount>3] < ViewGroup < * < * <2 [id="android:id/content"][childCount=2]',
